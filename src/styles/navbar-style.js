...
export const hamburgerButton =
  "flex justify-center items-center gap-3 cursor-pointer tablet:hidden z-50";
...
export const leftMenuDesktopStyle = "hidden tablet:flex gap-2 items-center";

export const leftMenuMobileStyle =
  "absolute flex justify-center items-center -bottom-[800px] left-0 right-0 gap-3 text-white z-[2000]";
